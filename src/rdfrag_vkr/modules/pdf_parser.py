"""PDF parsing module with GROBID-first extraction and pypdf fallback."""
...
class PDFParser:
    """Parse scientific PDFs into a common structured document schema."""
    ...
    def parse_pdf(self, pdf_path: Path) -> ParsedDocument:
        """Parse a single PDF, preferring GROBID and falling back to pypdf when allowed."""
    ...
    def save_document(self, document: ParsedDocument) -> Path:
        """Save one parsed document to data/parsed."""
